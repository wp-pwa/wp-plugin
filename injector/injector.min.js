!(function(n, o, e) {
  var t = /ip(hone|od).*?OS (?![1-8]_|X)/i,
    r = /ipad.*?OS (?![1-8]_|X)/i,
    a = /android.+chrome\/(?![123]\d\.)(.+mobile)/i,
    i = /android.+chrome\/(?![123]\d\.)(?!.+mobile)/i;
  (o["wp-pwa"].ssr_server = o["wp-pwa"].ssr_server.replace(/\/$/g, "") + "/"),
    (o["wp-pwa"].static_server =
      o["wp-pwa"].static_server.replace(/\/$/g, "") + "/");
  var p,
    s,
    c,
    d = function(e, t, r) {
    ...
    w = function(e) {
      for (
        var t = e + "=", r = decodeURIComponent(n.cookie).split(";"), o = 0;
        o < r.length;
        o++
      ) {
  ...
  if (w("wppwaClassicVersion"))
    !(function(e) {
      if (!n.getElementById(e.id)) {
        var t = n.getElementsByTagName(e.tag)[0],
          r = n.createElement(e.tag);
        (r.id = e.id), (r.src = e.src), t.parentNode.insertBefore(r, t);
      }
    })({
      tag: "script",
      id: "wppwaClassic",
    ...
    !w("wppwaInjectorFailed") &&
    e &&
    ((c = e.userAgent), t.test(c) || a.test(c))
  ) {
    o.stop();
    n.write(
      unescape(
    ...
    var l =
      ...
      o["wp-pwa"].id +
      "&static=" +
      encodeURIComponent(o["wp-pwa"].static_server) +
      "&perPage=" +
      o["wp-pwa"].per_page +
      "&device=" +
      ((s = e && e.userAgent), r.test(s) || i.test(s) ? "tablet" : "mobile") +
      "&initialUrl=" +
      encodeURIComponent(
        o["wp-pwa"].initial_url || o.location.origin + o.location.pathname
      );
    o["wp-pwa"].page && (l += "&page=" + o["wp-pwa"].page);
    var A = function(e, t) {
      var r = new XMLHttpRequest();
      r.open("POST", "https://api.rollbar.com/api/1/item/", !0),
        r.send(
          JSON.stringify({
            ...
            data: {
              ...
              body: {
                message: {
                  body: 'Injector "' + t + '" on: ' + o.location.href,
                  error: t,
                },
              },
            },
        ...
        console.error('Injector "' + t + '" on: ' + o.location.href);
    };
    ((p = new XMLHttpRequest()).timeout = 3e4),
      (p.onreadystatechange = function() {
        var e, t;
        4 === p.readyState &&
          (200 === p.status
            ? ((e = p.responseText),
              (t = n.open("text/html", "replace")).write(e),
              t.close())
            : (d("wppwaInjectorFailed", "true", 3), o.location.reload(!0)));
      }),
      (p.ontimeout = function() {
        A(0, "timeout"),
          d("wppwaInjectorFailed", "true", 3),
          o.location.reload(!0);
      }),
      (p.onerror = function() {
        A(0, "network error"),
      ...
      p.open("GET", o["wp-pwa"].ssr_server + l, !0),
      p.send();
  }
